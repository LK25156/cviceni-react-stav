...
const Kasicka = ({ pocatecniStav }) => {
  const [stavKasicky,setStavKasicky] = useState(pocatecniStav);
  ...
  return (
    <div className="kasicka">
      ...
      <button onClick={() => setStavKasicky(stavKasicky + 5)}>přihodit pětikorunu</button> 
      <button onClick={() => setStavKasicky(0)}>vysypat</button>
    </div>
  )
}
